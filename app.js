...
class UpgradeGame {
    ...
    showResultText(success, chance) {
        ...
        else { rt.textContent = 'ПРОИГРЫШ'; rt.style.color = '#ff6b6b'; rt.style.textShadow = '0 0 20px #ff6b6b, 0 0 40px #f85149'; rc.textContent = `Шанс: ${(chance*100).toFixed(1)}%`; rc.style.color = '#ff6b6b'; }
